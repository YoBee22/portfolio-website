...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfolio of Yogita Bisht, a Data Scientist and Software Engineer building production-ready ML systems and data pipelines." },
      { name: "author", content: "Yogita Bisht" },
